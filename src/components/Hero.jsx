    ...
    <>
      ...
      >
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="text-center">
              <div className="relative inline-block leading-none">
                ...
                <h1 className="relative font-black text-[70px] sm:text-[95px] md:text-[120px] lg:text-[150px]">UDIT</h1>
              </div>
            ...
            <div className="mt-10">
              <p className="text-base sm:text-lg md:text-xl font-semibold text-gray-900">Full Stack Developer</p>
              ...
              <div className="mt-10 flex flex-wrap items-center justify-center sm:justify-start gap-8">
                <motion.a whileHover={{ x: 4 }} onClick={() => scrollToSection("projects")} className="relative text-base md:text-lg font-medium cursor-pointer">
                  View Work
                  <span className="absolute left-0 -bottom-1 w-full h-[2px] bg-black"></span>
                </motion.a>

                <motion.a whileHover={{ x: 4 }} onClick={() => scrollToSection("contact")} className="text-base md:text-lg font-medium cursor-pointer flex items-center gap-2">
                  Contact -&gt;
                </motion.a>
              </div>
            </div>
        ...
        <motion.button
          ...
          className="md:hidden mt-8 z-20 flex flex-col items-center gap-1 text-black"
        >
          <span className="text-sm tracking-wide font-medium">Scroll Down</span>
          <motion.span
            animate={{ y: [0, 8, 0] }}
        ...
        <motion.button
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8 }}
          className="hidden md:flex absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex-col items-center gap-1 text-black"
        >
          <span className="text-sm tracking-wide font-medium">Scroll Down</span>
          <motion.span
            animate={{ y: [0, 8, 0] }}
